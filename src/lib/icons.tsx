...
export const GraduationIcon = (p: P) => (
  <Svg {...p}><path d="m2 9 10-5 10 5-10 5L2 9Z" /><path d="M6 11.5v4c0 1.4 2.7 2.5 6 2.5s6-1.1 6-2.5v-4" /><path d="M22 9v6" /></Svg>
);

export const RocketIcon = (p: P) => (
  <Svg {...p}><path d="M14.5 2.5c2.5 0 5 1 6.5 2.5s2.5 4 2.5 6.5c-3 0-6-1-8-3s-3-5-3-6Z" /><path d="M14.5 2.5c-2.5 2-7 7-9 13.5l3 3C14 17 19 12.5 21 10" /><path d="M9 15c-2 .3-3.3 1.2-4 2.3C4.3 18.6 4 21 4 21s2.4-.3 3.7-1c1.1-.7 2-2 2.3-4" /><circle cx="15" cy="9" r="1.5" /></Svg>
);

export const HandshakeIcon = (p: P) => (
  <Svg {...p}><path d="m2 12 4.5-4.5a2 2 0 0 1 2.8 0L11 9.2" /><path d="m22 12-4.5-4.5a2 2 0 0 0-2.8 0L13 9.2l3.5 3.5a1.5 1.5 0 0 1-2.1 2.1L11 11.3l-1 1a1.6 1.6 0 0 1-2.3 0v0a1.6 1.6 0 0 1 0-2.3L9.9 7.7" /><path d="m2 12 4 4 1.5-1.5M22 12l-4 4-1-1" /></Svg>
);

export const TargetIcon = (p: P) => (
  <Svg {...p}><circle cx="12" cy="12" r="9" /><circle cx="12" cy="12" r="5" /><circle cx="12" cy="12" r="1.3" /></Svg>
);

export const BulbIcon = (p: P) => (
  <Svg {...p}><path d="M9 18h6M10 21h4" /><path d="M12 3a6 6 0 0 0-3.5 10.9c.6.5.9 1.2.9 2.1h5.2c0-.9.4-1.6.9-2.1A6 6 0 0 0 12 3Z" /></Svg>
);

export const GearIcon = (p: P) => (
  <Svg {...p}><circle cx="12" cy="12" r="3.2" /><path d="M12 4v2.2M12 17.8V20M4 12h2.2M17.8 12H20M6.3 6.3l1.6 1.6M16.1 16.1l1.6 1.6M17.7 6.3l-1.6 1.6M7.9 16.1l-1.6 1.6" /></Svg>
);
